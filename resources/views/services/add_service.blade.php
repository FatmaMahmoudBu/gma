...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الخدمات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ طلب
                خدمة</span>
        </div>
    </div>
</div>
                    ...
                    <div class="row mg-b-20">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label for="type" class="control-label">نوع الخدمة</label>
                                <select name="type" id="type" class="form-control  nice-select  custom-select">
                                    <!--placeholder-->
